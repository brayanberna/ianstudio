...
SECRET_KEY = 'django-insecure-8t_157elhp^15e7-z+gz8^p+(6i79y3#4@1d6vl)u3&w5t&x^='
...
ROOT_URLCONF = 'ian_analytics.urls'
...
WSGI_APPLICATION = 'ian_analytics.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, '../frontend/public/static'), # Producción
]
...
#CORS_ALLOWED_ORIGINS = ['https://ianstudio.herokuapp.com']
